 ...
 <div class="row">
  <div class="col-md-12">
    <h1 class="page-header">
      Tipo de Vehículos <small>Registro principal de tipos de vehiculos</small>
    </h1>
     ...
     <div class="panel panel-default">
      ...
      <div class="panel-body">
       <div class="table-responsive">
       	<table class="display" id="tablaTipoVehiculo">
       	 <thead>
         <tr>
         ...
         <tbody>
             <?php
                      $json= file_get_contents(URL."TipoVehiculo/listado?id_entidad=".$_SESSION['id_entidad']);
                      $datos = json_decode($json);
                      foreach($datos as $tv){
                        echo "<tr>
                            <td> ". $tv->descripcion ."</td>
                            <td> <button class='btn btn-success' onclick='javascript:verventanamodalEditar($tv->id_tipo_vehiculo)'>Editar</button> </td>
                            <td> <button class='btn btn-danger' onclick='javascript:elimina_usuario($tv->id_tipo_vehiculo)'>Elimiar</button></td>
                              </tr>";
                      }
                     ?>
         </tbody>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Añadir/Editar Tipos de Vehiculos</h4>
            </div>
        <div class="modal-body">
            <form role="form">
                <div class="form-group">
                  ...
                  <button type="button"
                          class="btn btn-primary"
                          onclick="javascript:envia_tvehiculo()">Guardar</button>
             </form>
        </div>
...
$(document).ready(function(){
    ...
    function verventanamodalEditar(id){
        $.ajax({
            type:"POST",
            url:"<?php echo URL;?>TipoVehiculo/consulta",
            data:{id:id},
     ...
     function envia_tvehiculo(){
              ...
              if(xid_entidad=="" || xid_usuario=="" || xdescripcion==""){
                ...
                $.ajax({
                  type:"POST",
                  url:"<?php echo URL;?>TipoVehiculo/add",
                ...
                $.ajax({
                  type:"POST",
                  url:"<?php echo URL;?>TipoVehiculo/update",
