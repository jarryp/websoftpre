 ...
 <div class="row">
  <div class="col-md-12">
    <h1 class="page-header">
      Marcas de Vehículos <small>Registro principal de marcas de vehiculos</small>
    </h1>
     ...
     <div class="panel panel-default">
      ...
      <div class="panel-body">
       <div class="table-responsive">
       	<table class="display" id="tablaMarcaVehiculo">
       	 <thead>
         <tr>
         ...
         <tbody>
             <?php
                      $json= file_get_contents(URL."MarcaVehiculo/listado?id_entidad=".$_SESSION['id_entidad']);
                      $datos = json_decode($json);
                      foreach($datos as $mv){
                        echo "<tr>
                            <td> ". $mv->descripcion ."</td>
                            <td> <button class='btn btn-success' onclick='javascript:verventanamodalEditar($mv->id_marca_vehiculo)'>Editar</button> </td>
                            <td> <button class='btn btn-danger' onclick='javascript:elimina_usuario($mv->id_marca_vehiculo)'>Elimiar</button></td>
                              </tr>";
                      }
                     ?>
         </tbody>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Añadir/Editar Marcas de Vehiculos</h4>
            </div>
        <div class="modal-body">
            <form role="form">
                <div class="form-group">
                  ...
                  <button type="button"
                          class="btn btn-primary"
                          onclick="javascript:envia_marcavehiculo()">Guardar</button>
             </form>
        </div>
...
$(document).ready(function(){
    ...
    function verventanamodalEditar(id){
        $.ajax({
            type:"POST",
            url:"<?php echo URL;?>MarcaVehiculo/consulta",
            data:{id:id},
     ...
     function envia_marcavehiculo(){
              ...
              if(xid_entidad=="" || xid_usuario=="" || xdescripcion==""){
                ...
                $.ajax({
                  type:"POST",
                  url:"<?php echo URL;?>MarcaVehiculo/add",
                ...
                $.ajax({
                  type:"POST",
                  url:"<?php echo URL;?>MarcaVehiculo/update",
