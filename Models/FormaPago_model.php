<?php 
class FormaPago_model extends Conexion {
    private $tabla="forma_pago";
    private $id;
    private $id_entidad;
    private $descripcion;
    private $id_user;
    ...
    function consultaModel(){
	 return $this->db->select1(" id_forma_pago, descripcion",$this->tabla,"id_forma_pago=$this->id");
    }
    
    function listadoModel($id_entidad){ 
        $sql="select id_forma_pago, descripcion 
              from $this->tabla 
