<?php 
class TipoVehiculo_model extends Conexion {
    private $tabla="tipo_vehiculo";
    private $id;
    private $id_entidad;
    private $descripcion;
    private $id_user;
    ...
    function consultaModel(){
	 return $this->db->select1(" id_tipo_vehiculo, descripcion",$this->tabla,"id_tipo_vehiculo=$this->id");
    }
    
    function listadoModel($id_entidad){ 
        $sql="select id_tipo_vehiculo, descripcion 
              from $this->tabla 
